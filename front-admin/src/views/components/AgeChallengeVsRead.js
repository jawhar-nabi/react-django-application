  ...
  datasets: [
    {
      ...
      backgroundColor: '#0f84bd22',
      borderColor: '#0f84bd',
      pointBackgroundColor: '#0f84bd',
      pointBorderColor: '#fff',
      pointHoverBackgroundColor: '#0f84bd',
      pointHoverBorderColor: '#0f84bd',
...
class AgeChallengeVsRead extends Component {
...
export default AgeChallengeVsRead;