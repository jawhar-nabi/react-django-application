...
export class BlocMotivation extends Component{
    render(){
        return(
                      ...
                      <div className="product-slider countdown-single with-countdown sb-slick-slider product-border-reset" data-slick-setting="{
                        ...
                        <div className="single-slide " >
                          ...
                          <div className="product-card--body">
                             ...
                             <img src="image/challenge/motiv1.jpg" alt="" />
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="single-slide " >
                          ...
                          <div className="product-card--body">
                              <div className="card-image">
                              <img src="image/challenge/motiv2.jpg" alt="" />
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="single-slide " >
                          ...
                          <div className="product-card--body">
                              <div className="card-image">
                               <img src="image/challenge/motiv3.jpg" alt="" />
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="single-slide " >
                          ...
                          <div className="product-card--body">
                              <div className="card-image">
                               <img src="image/challenge/motiv4.jpg" alt="" />
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="single-slide " >
                          ...
                          <div className="product-card--body">
                              <div className="card-image">
                             <img src="image/challenge/motiv5.jpg" alt="" />
                              </div>
                            </div>
                          </div>
                        </div>
